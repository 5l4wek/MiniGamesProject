package pl.minigames.lotto.message;
...
public class LottoMessage {
    ...
    public static final String TYPE_THE_NUMBER = "Please type your number";
    public static final String PASS_THE_NUMBERS = "Please pass your numbers";
    public static final String NUMBER_NOT_IN_RANGE = "Incorrect input";
